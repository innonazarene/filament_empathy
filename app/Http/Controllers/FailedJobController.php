...
class FailedJobController extends Controller
{
    ...
    {
        return response()->json($this->displayRequest(NULL,$request,new FailedJob));
    }
    ...
    {
        return FailedJob::create($request->all());
    }
    ...
    {
        return response()->json($this->displayRequest($id,$request,new FailedJob));
    }
