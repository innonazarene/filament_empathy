...
class PersonalAccessTokenController extends Controller
{
    ...
    {
        return response()->json($this->displayRequest(NULL,$request,new PersonalAccessToken));
    }
    ...
    {
        return PersonalAccessToken::create($request->all());
    }
    ...
    {
        return response()->json($this->displayRequest($id,$request,new PersonalAccessToken));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = PersonalAccessToken::find($id);
