<div class="bg-[#fff7ea]">
    <div class="p-4 w-full flex justify-center">
        <p class="font-bold text-lg text-gray-800 border-b-2 border-gray-800">
            LISTENERS / COUNSELING
        </p>
    </div>
    <div class="p-4 grid md:grid-cols-3 grid-cols-1 gap-5 justify-center">
